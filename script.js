...
const viewMoreItems = document.querySelectorAll(
  "#job-info .container .card-item .view-more"
);
const viewMoreBtnList = document.querySelectorAll(
  "#job-info .container .card-item .view-more .btn-view-more"
);
const cardItemContentList = document.querySelectorAll(
  "#job-info .container .card-item .content"
);
